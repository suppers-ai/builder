...
func UpdateCollection(svc *services.Service) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		respondWithJSON(w, http.StatusNotImplemented, map[string]string{"message": "Not implemented"})
	}
}
...
func WebSocketHandler(svc *services.Service) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		respondWithJSON(w, http.StatusNotImplemented, map[string]string{"message": "WebSocket not implemented"})
	}
}