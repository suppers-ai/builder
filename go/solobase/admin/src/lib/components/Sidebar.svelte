<script lang="ts">
	...
	$: console.log('Sidebar - currentUser prop:', currentUser);
...
<aside class="sidebar {collapsed ? 'collapsed' : ''}">
	...
	<div class="sidebar-header">
		<a href="/" class="sidebar-logo">
			...
			{:else}
				<img src="/logo_long.png" alt="Solobase" height="50" style="height: 50px; width: auto;" />
			{/if}
		</a>
	</div>
...
<style>
	.sidebar > *:not(.profile-menu):not(.sidebar-user-container) * {
