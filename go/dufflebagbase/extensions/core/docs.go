...
func (dg *DocumentationGenerator) GenerateMarkdown() (string, error) {
	...
	// Header
	buf.WriteString("# DuffleBagBase Extensions Documentation\n\n")
...
func (dg *DocumentationGenerator) GenerateOpenAPI() ([]byte, error) {
	spec := map[string]interface{}{
		...
		"info": map[string]interface{}{
			"title":       "DuffleBagBase Extensions API",
			"version":     "1.0.0",
			"description": "Auto-generated API documentation for DuffleBagBase extensions",
		},
...
Add this extension to your DuffleBagBase configuration:
