...
export default function ThemeControllerDemo() {
  const examples = [
    {
      title: "Radio Theme Controller",
      description: "Theme selection using radio buttons",
  ...
  <input type="radio" name="theme" class="radio radio-accent" value="cupcake" />
      ...
      preview: (
        <div class="flex gap-2">
          <input type="radio" name="theme-demo" class="radio radio-primary" checked />
          <input type="radio" name="theme-demo" class="radio radio-secondary" />
          <input type="radio" name="theme-demo" class="radio radio-accent" />
        </div>
      ),
    },
    {
      title: "Color Grid Theme Controller",
      description: "Visual theme selection with color previews",
      code: `<div class="grid grid-cols-5 gap-2">
  ...
  <div class="tooltip" data-tip="Cupcake">
        ...
        <div class="grid grid-cols-5 gap-2">
          <div class="tooltip" data-tip="Light">
            <input
              ...
              style="background: #ffffff; border-color: #d1d5db;"
              checked
            />
          </div>
          <div class="tooltip" data-tip="Dark">
          ...
          <div class="tooltip" data-tip="Cupcake">
            <input
              ...
              name="theme-grid"
              class="radio radio-sm"
              style="background: #fce7f3; border-color: #f3e8ff;"
            />
          </div>
          <div class="tooltip" data-tip="Bumblebee">
            <input
              type="radio"
              name="theme-grid"
              class="radio radio-sm"
              style="background: #fef3c7; border-color: #fbbf24;"
            />
          </div>
          <div class="tooltip" data-tip="Emerald">
            <input
              type="radio"
              name="theme-grid"
              class="radio radio-sm"
    ...
    {
      title: "Dropdown Theme Controller",
      description: "Theme selection via dropdown menu",
  ...
  <ul class="dropdown-content menu p-2 shadow bg-base-100 rounded-box w-52">
    ...
    {
      title: "Toggle Theme Controller",
      description: "Simple light/dark toggle switch",
      code: `<label class="swap swap-rotate">
  <input type="checkbox" />
  ...
  const relatedComponents = [
    ...
    { name: "Swap", path: "/components/action/swap" },
  ];
