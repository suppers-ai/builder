...
const syntaxPatterns = {
  tsx: [
    ...
    { pattern: /\b(import|export|from|as|default|const|let|var|function|class|interface|type|enum|namespace)\b/g, className: 'text-primary font-semibold' }, // Keywords
    { pattern: /\b(string|number|boolean|object|undefined|null|void|any|unknown|never)\b/g, className: 'text-secondary font-semibold' }, // Types
...
export default function SyntaxHighlighter({
  ...
  return (
    <>
      <div class="relative border border-base-300 rounded-lg overflow-hidden syntax-highlighter-container" tabIndex={0}>
