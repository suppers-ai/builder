...
import { Alert, Badge, Button, Card, Modal, Table } from "@suppers/ui-lib";
...
export default function ApplicationManager({
  ...
  const handleDownload = async (app: GeneratedApplication) => {
    try {
      ...
      downloadingApps.value = new Set(
        [...downloadingApps.value].filter((name) => name !== app.name),
      );
    }
  };
    ...
    <div class="space-y-6">
          ...
          <Card>
            <div class="card-body text-center py-12">
              ...
              <p class="text-base-content/70 mb-6">
                You haven't generated any applications yet. Create your first application to get
                started.
              </p>
      ...
      >
        <div class="modal-box">
          ...
          <p class="mb-6">
            Are you sure you want to delete "{deleteModal.value.app?.name}"? This action cannot be
            undone and will permanently remove all generated files.
          </p>
