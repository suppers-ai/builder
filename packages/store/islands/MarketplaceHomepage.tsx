...
import type { Tables } from "@suppers/shared/generated/database-types.ts";
  ...
  const mockTemplates: ApplicationTemplate[] = [
    {
      ...
      description: "Professional landing page template with hero section, features, and contact form",
      category: "business",
      preview: {
                ...
                <Card key={app.id} class="hover:shadow-lg transition-shadow duration-300">
                  <div class="p-6">
                    <div class="flex justify-between items-start mb-4">
                      ...
                      <div class={`badge ${app.status === 'published' ? 'badge-success' : 
                        app.status === 'draft' ? 'badge-warning' : 
                        app.status === 'pending' ? 'badge-info' : 'badge-neutral'}`}>
                        {app.status}
                      </div>
                    </div>
        ...
        <div class="container mx-auto px-4">
          <div class="text-center mb-12">
            ...
            <p class="text-xl text-base-content/80 max-w-3xl mx-auto">
              Choose from our curated collection of templates to jumpstart your application development.
            </p>
          </div>
            ...
            {displayTemplates.map((template) => (
              ...
              >
                <div class="relative">
                  ...
                  {/* Category Badge */}
                  <div class={`badge ${getCategoryColor(template.category)} absolute top-4 right-4`}>
                    {template.category}
                  </div>
                </div>
      ...
      <section class="py-16 bg-base-100">
        <div class="container mx-auto px-4">
          <div class="text-center mb-12">
            ...
            <p class="text-xl text-base-content/80 max-w-3xl mx-auto">
              Built for developers, designed for creators. Generate applications with
              our powerful compiler and intuitive interface.
            </p>
          </div>
          ...
          <div class="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            ...
            <Card class="text-center p-8 hover:shadow-xl transition-all duration-300">
              ...
              <p class="text-base-content/70 leading-relaxed">
                Lightning-fast application generation with our optimized compiler. From concept
                to deployment in minutes, not hours.
              </p>
            </Card>
            ...
            <Card class="text-center p-8 hover:shadow-xl transition-all duration-300">
              ...
              <p class="text-base-content/70 leading-relaxed">
                Choose from a rich library of templates and components. Start with proven
                patterns and customize to your needs.
              </p>
            </Card>
          </div>
        </div>
