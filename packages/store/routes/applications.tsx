...
const mockApplications = [
  {
    id: "1",
    thumbnail: 'https://images.unsplash.com/photo-1598300042247-d088f8ab3a91?w=100&h=100&fit=crop&crop=center',
    name: "VoiceChat Pro",
  ...
  {
    id: "2", 
    thumbnail: 'https://images.unsplash.com/photo-1541961017774-22349e4a1262?w=100&h=100&fit=crop&crop=center',
    name: "Digital Canvas",
  ...
  {
    id: "3",
    thumbnail: 'https://images.unsplash.com/photo-1461749280684-dccba630e2f6?w=100&h=100&fit=crop&crop=center',
    name: "CodeForge IDE",
              ...
              <div class="flex items-start gap-4">
                ...
                <div class="flex-1 min-w-0">
                  <div class="flex items-start justify-between mb-1">
                    ...
                    <div class={`text-xs px-2 py-1 rounded-full ml-2 flex-shrink-0 ${
                      app.status === 'good' ? 'text-green-600 bg-green-100' : 'text-red-600 bg-red-100'
                    }`}>
                  ...
                  <div class="flex items-center justify-between">
                    <span class={`text-sm ${
                      app.status === 'good' ? 'text-green-600' : 'text-red-600'
                    }`}>
                      {app.votes} votes
                    </span>
                  </div>
