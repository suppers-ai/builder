  ...
  const mockTemplates: ApplicationTemplate[] = [
    {
      ...
      description:
        "Professional landing page template with hero section, features, and contact form. Perfect for showcasing your business and converting visitors into customers.",
      category: "business",
      preview: {
    ...
    },
    {
      ...
      description:
        "Showcase your work with this modern portfolio template. Features a clean design with project galleries and smooth animations.",
      category: "portfolio",
      preview: {
    ...
    },
    {
      ...
      name: "Minimal Blog",
      description:
        "Clean and simple blog template for content creators. Focus on readability and user experience with modern typography.",
      category: "blog",
      preview: {
    ...
    },
    {
      ...
      description:
        "Full-featured online store with product catalog and checkout. Includes inventory management and payment processing.",
      category: "ecommerce",
      preview: {
    ...
    },
    {
      ...
      description:
        "Comprehensive admin dashboard with charts and data management. Perfect for managing applications and analyzing data.",
      category: "dashboard",
      preview: {
    ...
    },
    {
      ...
      description:
        "Stunning portfolio template designed specifically for photographers. Features full-screen galleries and elegant layouts.",
      category: "portfolio",
      preview: {
    ...
    },
    {
      ...
      name: "Magazine Blog",
      description:
        "Feature-rich magazine-style blog template with multiple layouts and advanced content organization.",
      category: "blog",
      preview: {
    ...
    },
    {
      ...
      description:
        "Modern SaaS landing page with pricing tables, feature comparisons, and conversion-optimized design.",
      category: "business",
      preview: {
    ...
    },
    {
      ...
      description:
        "Advanced marketplace template supporting multiple vendors with comprehensive seller and buyer management.",
      category: "ecommerce",
      preview: {
    ...
    },
    {
      ...
      description:
        "Specialized analytics dashboard with advanced charting and data visualization capabilities.",
      category: "dashboard",
      preview: {
