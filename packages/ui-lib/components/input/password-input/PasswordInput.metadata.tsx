...
<PasswordInput size="lg" />`,
  ...
  },
  {
    ...
    code: `<PasswordInput color="primary" />
<PasswordInput color="success" placeholder="Strong password" />
<PasswordInput color="warning" placeholder="Weak password" />
<PasswordInput color="error" placeholder="Invalid password" />`,
    showCode: true,
  },
  {
    title: "Password Input Variants",
    description: "Different visual styles and states",
    code: `<PasswordInput bordered />
<PasswordInput ghost />
