    ...
    return (
      <div class="flex items-center justify-center min-h-screen">
        <div class="text-center">
          ...
          <p class="text-gray-600 mb-4">Please log in to view your account.</p>
          <a
            href="/login"
            ...
            <div class="flex-1">
              ...
              <div class="flex items-center gap-3 flex-wrap">
                ...
                {isAdmin && (
                  <a
                    href="/admin"
                    class="bg-purple-500 hover:bg-purple-600 text-white px-4 py-2 rounded-md font-medium transition-colors"
                  >
                    🔧 Admin Panel
                  </a>
                )}
                <button
                  ...
                  class="bg-gray-500 hover:bg-gray-600 text-white px-4 py-2 rounded-md font-medium disabled:opacity-50 disabled:cursor-not-allowed transition-colors flex items-center gap-2"
                >
                  {isSigningOut
                    ? (
                      <>
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-6">
        <div class="bg-white rounded-lg shadow-md border border-gray-200 p-6">
          <div class="flex items-center">
            ...
            <div class="ml-4">
              <h3 class="text-lg font-semibold text-gray-900">Total Apps</h3>
              {isLoadingStats
        ...
        <div class="bg-white rounded-lg shadow-md border border-gray-200 p-6">
          <div class="flex items-center">
            ...
            <div class="ml-4">
              ...
              {isLoadingStats
                ? <div class="animate-pulse bg-gray-200 h-8 w-16 rounded"></div>
                : <p class="text-3xl font-bold text-gray-600">{userStats.draftApplications}</p>}
            </div>
          </div>
        </div>
      </div>
              ...
              {isLoadingStats
                ...
                ? (
                  <div class="text-center py-8 text-gray-500">
                    ...
                    <a
                      href="/my-applications"
                      class="mt-3 inline-block bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded-md font-medium"
                    >
                      Create Application
                    </a>
                  </div>
            ...
            <div class="p-6">
              ...
              <div class="space-y-3">
                ...
                <div>
                  ...
                  <p class="text-gray-500 text-xs font-mono break-all">{user.id}</p>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="p-6">
              ...
              <div class="space-y-3">
                ...
                >
                  ...
                  <div>
                    <h3 class="font-medium text-gray-900 text-sm">Browse Apps</h3>
                    <p class="text-xs text-gray-600">Discover published applications</p>
                  </div>
                </a>
                <button
                  onClick={onShowEditModal}
                ...
                >
                  ...
                  <div>
                    <h3 class="font-medium text-gray-900 text-sm">Edit Profile</h3>
                ...
                >
                  <span class="text-xl">📱</span>
                  <div>
                    <h3 class="font-medium text-gray-900 text-sm">Manage Apps</h3>
                    <p class="text-xs text-gray-600">Create and edit your applications</p>
                  </div>
                </a>
                {isAdmin && (
                  <a
                  ...
                  >
                    <span class="text-xl">🔧</span>
                    <div>
                      <h3 class="font-medium text-gray-900 text-sm">Admin Panel</h3>
                      <p class="text-xs text-gray-600">Review pending applications</p>
                    </div>
                  </a>
                )}
              </div>
            ...
            <div class="p-6">
              ...
              <div class="space-y-3">
                ...
                >
                  <span class="text-xl">🔒</span>
                  <div>
                    <h3 class="font-medium text-gray-900 text-sm">Change Password</h3>
                ...
                >
                  <span class="text-xl">🛡️</span>
                  <div>
                    <h3 class="font-medium text-gray-900 text-sm">Two-Factor Auth</h3>
                    <p class="text-xs text-gray-600">Enable 2FA security</p>
                  </div>
                </button>
                <button
