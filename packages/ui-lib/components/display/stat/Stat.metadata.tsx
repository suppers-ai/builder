      ...
      <div class="space-y-6">
        <div class="stats shadow w-full">
          <div class="stat">
            ...
            <div class="stat-desc">↗︎ $12,483 (18.2%) from last month</div>
          </div>
          <div class="stat">
            <div class="stat-figure text-secondary">
              <div class="avatar">
            ...
            <div class="stat-desc">↗︎ 89 (2.4%) from yesterday</div>
          </div>
          <div class="stat">
            <div class="stat-figure text-secondary">
              <div class="avatar">
            ...
            <div class="stat-desc">↗︎ 127 new this week</div>
          </div>
        </div>
        ...
        <div class="stats shadow w-full">
          <div class="stat">
            ...
            <div class="stat-desc">↗︎ 0.18% from last week</div>
          </div>
          <div class="stat">
            <div class="stat-title">Average Order</div>
            <div class="stat-value">$247.83</div>
            <div class="stat-desc">↗︎ $23.11 increase</div>
          </div>
          <div class="stat">
            <div class="stat-title">Return Rate</div>
            <div class="stat-value">1.2%</div>
            <div class="stat-desc">↘︎ 0.3% decrease (good)</div>
          </div>
          <div class="stat">
            <div class="stat-title">Satisfaction</div>
            <div class="stat-value">4.8/5</div>
            <div class="stat-desc">Based on 2,847 reviews</div>
          </div>
        </div>
      </div>
    ),
