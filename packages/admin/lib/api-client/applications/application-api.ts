import { BaseApiClient, ApiResponse, PaginatedApiResponse } from "../base-api-client.ts";
import type {
  ApplicationStatus,
  ApplicationFilters,
  AdminApplication,
...
export class ApplicationApiClient extends BaseApiClient {
  async getApplicationsFiltered(filters: ApplicationFilters = {}): Promise<ApiResponse<PaginatedApiResponse<AdminApplication>>> {
    try {
  ...
  async updateApplication(id: string, data: UpdateApplicationData): Promise<ApiResponse<AdminApplication>> {
  ...
  async updateApplicationStatus(id: string, status: ApplicationStatus): Promise<ApiResponse<AdminApplication>> {
