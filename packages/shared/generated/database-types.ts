    ...
    Tables: {
      ...
      applications: {
        Row: {
          ...
          display_entities_with_tags: string[] | null
          id: string
          metadata: Json | null
          name: string
          slug: string
      ...
      billing_configs: {
        ...
        Relationships: [
          {
            foreignKeyName: "billing_configs_product_id_fkey"
            columns: ["product_id"]
            isOneToOne: true
      ...
      entities: {
        Row: {
          connected_application_ids: string[] | null
          created_at: string
          description: string | null
          ...
          filter_date_1: string | null
          filter_date_2: string | null
          filter_date_3: string | null
          filter_date_4: string | null
          filter_date_5: string | null
      ...
      entity_likes: {
        ...
        Relationships: [
          {
            foreignKeyName: "entity_likes_entity_id_fkey"
            columns: ["entity_id"]
            isOneToOne: false
          ...
          {
            foreignKeyName: "entity_likes_user_id_fkey"
            columns: ["user_id"]
            isOneToOne: false
            referencedRelation: "users"
            referencedColumns: ["id"]
      ...
      entity_sub_types: {
        ...
        Relationships: [
          {
            foreignKeyName: "entity_sub_types_entity_type_id_fkey"
      ...
      pricing_formulas: {
        ...
        Relationships: [
          {
            foreignKeyName: "pricing_formulas_pricing_product_id_fkey"
            columns: ["pricing_product_id"]
            isOneToOne: false
      ...
      pricing_prices: {
        ...
        Relationships: [
          {
            foreignKeyName: "pricing_prices_pricing_product_id_fkey"
            columns: ["pricing_product_id"]
            isOneToOne: false
            referencedRelation: "pricing_products"
            referencedColumns: ["id"]
      ...
      pricing_products: {
        ...
        Relationships: [
          {
            foreignKeyName: "pricing_products_owner_id_fkey"
            columns: ["owner_id"]
            isOneToOne: false
            referencedRelation: "users"
            referencedColumns: ["id"]
      ...
      product_cancellation_policies: {
        ...
        Relationships: [
          {
            foreignKeyName: "product_cancellation_policies_cancellation_policy_id_fkey"
          ...
          {
            foreignKeyName: "product_cancellation_policies_product_id_fkey"
            columns: ["product_id"]
            isOneToOne: false
            referencedRelation: "products"
            referencedColumns: ["id"]
      ...
      product_pricing: {
        ...
        Relationships: [
          {
            foreignKeyName: "product_pricing_pricing_product_id_fkey"
            columns: ["pricing_product_id"]
            isOneToOne: false
            referencedRelation: "pricing_products"
            referencedColumns: ["id"]
      ...
      product_sub_types: {
        ...
        Relationships: [
          {
            foreignKeyName: "product_sub_types_product_type_id_fkey"
      ...
      purchases: {
        ...
        Relationships: [
          {
            foreignKeyName: "purchases_pricing_price_id_fkey"
            columns: ["pricing_price_id"]
            isOneToOne: false
            referencedRelation: "pricing_prices"
            referencedColumns: ["id"]
          },
          {
      ...
      subscriptions: {
        ...
        Relationships: [
          {
            foreignKeyName: "subscriptions_pricing_price_id_fkey"
            columns: ["pricing_price_id"]
            isOneToOne: false
            referencedRelation: "pricing_prices"
            referencedColumns: ["id"]
      ...
      variables: {
        ...
        Relationships: [
          {
            foreignKeyName: "variables_entity_id_fkey"
            columns: ["entity_id"]
            isOneToOne: false
            referencedRelation: "entities"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "variables_product_id_fkey"
            columns: ["product_id"]
            isOneToOne: false
            referencedRelation: "products"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "variables_user_id_fkey"
            columns: ["user_id"]
            isOneToOne: false
            referencedRelation: "users"
            referencedColumns: ["id"]
