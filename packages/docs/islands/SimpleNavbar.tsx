...
import { Button, LogoIsland } from "@suppers/ui-lib";
    ...
    <div class="navbar bg-base-100">
      ...
      <div class="navbar-center">
        <ul class="menu menu-horizontal px-1 gap-4 hidden md:flex">
          <li>
            <Button
              onClick={() => globalThis.location.href = "/applications?return=/"}
              class={`font-medium ${
          ...
          <li>
            <Button
              onClick={() => globalThis.location.href = "/admin/create"}
              class={`font-medium ${
                currentPath === "/admin/create" ? "text-primary" : "text-base-content hover:text-primary"
              } bg-transparent border-none`}
              variant="ghost"
            >
              Create
      ...
      <div class="navbar-end">
        {/* Mobile menu - dropdown (shown on mobile) */}
        <div class="md:hidden">
          <div class="dropdown dropdown-end">
            ...
            >
              ...
              <li>
                <a
                  href="/admin/create"
                  class={currentPath === "/admin/create" ? "active" : ""}
                >
                  Create
                </a>
              </li>
        ...
        {/* SimpleAuthButton (shown on desktop, far right) */}
