  ...
  try {
    ...
    if (!filePath) {
      ...
      const files = (storageObjects || []).map((obj: any) => ({
        ...
        object_type: obj.object_type || "file",
        parent_folder_id: obj.parent_folder_id || null,
    ...
    return new Response(
      JSON.stringify({
        ...
        data: {
          ...
          object_type: storageObject.object_type || "file",
          parent_folder_id: storageObject.parent_folder_id || null,
